function App() {
	return (
		<>
			<div class="bg-gray-300 p-[1rem] grid grid-flow-col justify-evenly justify-items-center items-center w-full gap-[1rem]">
				{/* Card 1 */}
